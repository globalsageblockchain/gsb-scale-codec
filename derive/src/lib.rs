// Copyright 2025 Gsb Technologies
//
...
/// Derive `gsb_scale_codec::Encode` and `gsb_scale_codec::EncodeLike` for struct and enum.
///
...
///   implement `gsb_scale_codec::HasCompact` and will be encoded as `HasCompact::Type`.
/// * `#[codec(encoded_as = "$EncodeAs")]`: the field is encoded as an alternative type. $EncodedAs
///   type must implement `gsb_scale_codec::EncodeAsRef<'_, $FieldType>` with $FieldType the type
///   of the field with the attribute. This is intended to be used for types implementing
///   `HasCompact` as shown in the example.
///
/// ```
/// # use gsb_scale_codec_derive::Encode;
/// # use gsb_scale_codec::{Encode as _, HasCompact};
/// #[derive(Encode)]
/// struct StructType {
///     #[codec(skip)]
///     a: u32,
...
/// ```
/// # use gsb_scale_codec_derive::Encode;
/// # use gsb_scale_codec::Encode as _;
/// #[derive(Encode)]
/// enum EnumType {
///     #[codec(index = 15)]
///     A,
...
/// Derive `gsb_scale_codec::Decode` for struct and enum.
///
...
/// Derive `gsb_scale_codec::DecodeWithMemTracking` for struct and enum.
...
/// Derive `gsb_scale_codec::Compact` and `gsb_scale_codec::CompactAs` for struct with single
/// field.
///
...
///
/// ```
/// # use gsb_scale_codec_derive::CompactAs;
/// # use gsb_scale_codec::{Encode, HasCompact};
...
/// Derive `gsb_scale_codec::MaxEncodedLen` for struct and enum.
///
/// # Top level attribute
///
...
/// ```
/// # use gsb_scale_codec_derive::Encode;
/// # use gsb_scale_codec::MaxEncodedLen;

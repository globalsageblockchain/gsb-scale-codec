...
#[macro_use]
extern crate gsb_scale_codec_derive;
...
#[cfg(feature = "derive")]
pub use gsb_scale_codec_derive::*;
...
// `gsb-scale-codec-derive` is used on its own and this crate doesn't have the feature enabled.
#[doc(hidden)]
pub mod __private {
...
/// be guaranteed that the `gsb_scale_codec` module is available at the call site. In that
/// case, the macro should reexport the `gsb_scale_codec` module and specify the path to the
/// reexport:
///
/// ```ignore
/// pub use gsb_scale_codec as codec;
///
/// #[derive(Encode, MaxEncodedLen)]
...
pub use gsb_scale_codec_derive::MaxEncodedLen;

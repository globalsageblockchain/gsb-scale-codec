...
for types used in the Gsb Matter framework.
...
take a look at the ["Type encoding (SCALE)" page in Matter docs](https://docs.matter.bitzal.org/reference/scale-codec/).
...
them even more space/memory efficient. The compact encoding is described [here](https://docs.matter.bitzal.org/reference/scale-codec/#fn-1).
...
# use gsb_scale_codec_derive::{Encode, Decode};

use gsb_scale_codec::{Encode, Decode};
...
use gsb_scale_codec::{Encode, Decode, Compact, HasCompact};
...
use gsb_scale_codec::{Encode, Decode, Compact, HasCompact, CompactAs, Error};
